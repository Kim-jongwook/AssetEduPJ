      ...
      <tbody class="table-group-divider" >
        <c:forEach var="corp" items="${list}" varStatus="status">
            <tr class="align-middle">
              ...
              <td class="text-center">${corp.com01CorpNm }</td>
              <td class="text-center">${corp.com01CorpEnm }</td>
...
function go(no){
	alert(no);
	 var searchText = $('#searchText').val();
    AssetUtil.submitGet('/corp/list', {currentPageNumber:no,searchText: searchText});
};
</script>
</body>
</html>