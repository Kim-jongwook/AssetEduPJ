...
<body>
	...
	<main class="container mx-3 my-3">
		...
		<div class="row">
			<div class="col-6">
					...
					<tbody class="table-group-divider">
						<c:forEach var="code" items="${listCategory}" varStatus="status">
							<tr class="align-middle">
								...
								<td><input type="hidden" name="com02UseYn"
									value="${code.com02UseYn }" />
									<button class="btn btn-primary btn-sm btnCategoryModify"
										data-bs-target="#newComCd">
										<span><i class="fa-regular fa-pen-to-square"></i></span>
									</button>
									<button class="btn btn-danger btn-sm btnCategoryDelete"
										data-comcd="${code.com02ComCd}"
										data-comnm="${code.com02CodeNm}">
				...
				<kfs:Pagination pageAttr="${pageAttr }" id="com02CodePagination" functionName="go"></kfs:Pagination>
				<p>
			...
			<!-- modal -->
			<div class="modal fade" id="newComCd" data-bs-keyboard="false"
				...
				<div
					...
					<div class="modal-content">
						<form method="POST" id="formNewCode" class="validcheck">
							...
							<input type="hidden" id="formNewCode_Mode" /> <input
								type="hidden" name="com02DtlCd" value="NONE" /> <input
								type="hidden" name="com02CodeType" value="C" />
							...
							<div class="modal-body">
								<div class="mb-3">
									...
									<input class="form-control is-valid" name="com02ComCd"
										placeholder="코드(알파벳만)" required pattern="[a-z|A-Z]+"
										data-v-min-length="3" data-v-max-length="100" />
								</div>
								<div class="mb-3">
									<label for="com02ComNm" class="form-label fw-bold">공통코드명</label>
									<input type="text" class="form-control is-valid"
										name="com02CodeNm" placeholder="공통코드명" required />
								</div>
								<div class="mb-3">
									<label for="com02Seq" class="form-label fw-bold">순서</label> <input
										type="text" class="form-control" name="com02Seq" required
										pattern="[0-9]+" />
								</div>
								<div class="mb-3 align-middle">
									<label for="com02UseYn" class="form-label fw-bold">사용여부</label>&nbsp;
									<input type="radio" name="com02UseYn" id="com02UseYn11"
										value="true" checked /> <label for="com02UseYn11"> 사용함</label>&nbsp;
									<input type="radio" name="com02UseYn" id="com02UseYn22"
										value="false" /> <label for="com02UseYn22"> 사용안함</label>
								</div>
								<div class="mb-3">
									<label for="com02Note" class="form-label align-top fw-bold">코드설명</label>
									<textarea class="form-control" name="com02Note" rows="3"
										cols="50"></textarea>
								</div>
							</div>
							<div class="modal-footer d-flex justify-content-center">
								<button type="button" class="btn btn-primary"
									id="btnInsertComCd">저장</button>
	...
	<script>
		...
		function go(no){
			alert(no + "페이지입니다.");
			var searchText = $("#searchText").val();
			AssetUtil.submitGet("/code/list", {searchText: searchText, currentPageNumber: no});
		}
	</script>
</body>
</html>