        ...
        <form:form action="/fund/insert" method="POST" modelAttribute="fund" class="validcheck" >
            <table class="table table-sm table-borderless">
                ...
                <tr class="align-middle">
                    ...
                    <td><form:input type="text" class="form-control w-50 dateinput" path="fnd01StartDate" placeholder="YYYY-MM-DD" /></td>
                    <td style="width:50px">&nbsp;</td>
                </tr>
                <tr class="align-middle">
                    ...
                    <td><form:input type="text" class="form-control w-50 dateinput" path="fnd01EndDate" placeholder="YYYY-MM-DD" /></td>
                    <td style="width:50px">&nbsp;</td>
                </tr>
                <tr class="align-middle">
                    ...
                    <td><form:input type="text" class="form-control w-50 dateinput" path="fnd01FirstCloseDate" placeholder="YYYY-MM-DD"/></td>
                    <td style="width:50px">&nbsp;</td>
                </tr>
                <tr class="align-middle">
                ...
                <tr class="align-middle">
                    ...
                    <td class="w-25">
                        <form:select id="moja" path="fnd01ParentCd" class="form-select">
                            <form:option label="선택" value="" />
                    ...
                    <td>
                        ...
                        <form:input type="text" class="form-control bg-light" path="fnd01MngCoNm" readonly="true" placeholder="기관팝업에서 선택"/>
                    </td>
                ...
                <tr class="align-middle">
                    ...
                    <td>
                        ...
                        <form:input type="text" class="form-control bg-light" path="fnd01ParentFundNm" readonly="true" placeholder="펀드팝업에서 선택"/>
                    </td>
                    ...
                    <td>
                        ...
                        <form:input type="text" class="form-control bg-light" path="fnd01TrustCoNm" readonly="true" placeholder="기관팝업에서 선택"/>
                    </td>
                ...
                <tr class="align-middle">
                    ...
                    <td>
                        ...
                        <form:input type="text" class="form-control bg-light" path="fnd01OfficeCoNm" readonly="true" placeholder="기관팝업에서 선택"/>
                    </td>
...
$(document).ready(function () {
	...
	$('#btnPopupFund').on('click', function(){
	    if ($("#moja").val() == 3) {
	        ...
	        alert("모/자 구분이 자신탁일 경우만 선택 가능합니다.");
	        return false;
	    }
	});
