...
<!-- =================================================== -->
<title><c:out value="${pageTitle}" default="주식종목정보-수정" /></title>
</head>
<body>
<!-- =================================================== -->
        ...
        <form:form action="/item/update" method="POST" modelAttribute="item" class="validcheck" >
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    ...
                    <td style="width:300px"><form:input type="text" id="itm01ItemCd" class="form-control bg-light" path="itm01ItemCd" data-v-max-length="12" data-v-min-length="12" required="true" readonly="true" /></td>
                ...
                <tr class="align-middle">
                    ...
                    <td><form:input type="text" class="form-control amtinput" path="itm01Par"/></td>
                    <td colspan=2></td>
                </tr>
                <tr class="align-middle">
