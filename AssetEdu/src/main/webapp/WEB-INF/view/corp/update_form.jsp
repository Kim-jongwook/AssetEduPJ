...
<!-- =================================================== -->
<title><c:out value="${pageTitle}" default="기관정보-수정" /></title>
</head>
<body>
<!-- =================================================== -->
        ...
        <form:form action="/corp/update" method="POST" modelAttribute="corp" class="validcheck" >
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    ...
                    <td><form:input type="text" id="com01CorpCd" class="form-control w-25 bg-light" path="com01CorpCd" data-v-max-length="5" data-v-min-length="5" readonly="true" /></td>
                </tr>
                <tr class="align-middle">
            ...
            <div class="row justify-content-md-center pt-5">
                <button type="submit" class="col col-lg-2 btn btn-primary">수정</button>
                &nbsp;
