...
-- user 테이블 데이터 모두 삭제
delete from public.sys01_user; 

-- 데이터 생성 130이 만들어지는 데이터 갯수임
INSERT INTO public.sys01_user
...
select
    ...
    '1111'  || i::text,
    '010-1234-'  || i::text,
     concat('hong' ,  i::text,'@gmail.com')
from 
	generate_series(1, 130) s(i)
	;
