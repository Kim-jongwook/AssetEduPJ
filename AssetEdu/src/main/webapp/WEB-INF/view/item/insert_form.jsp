        ...
        <form:form action="/item/insert" method="POST" modelAttribute="item" class="validcheck" >
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    ...
                    <td style="width:300px"><form:input type="text" class="form-control" path="itm01ItemCd" data-v-max-length="12" data-v-min-length="12" required="true" placeholder="필수입력(12자리)" /></td>
                    <td style="width:150px"><form:input type="text" class="form-control" path="itm01ShortCd" placeholder="입력"/></td>
                    <td></td>
                </tr>
                <tr class="align-middle">
                ...
                <tr class="align-middle">
                    ...
                    <td><form:input type="text" class="form-control amtinput" path="itm01Par" placeholder="입력"/></td>
                    <td colspan=2></td>
                </tr>
                <tr class="align-middle">
                    ...
                    <td>
                        ...
                        <form:input type="text" class="form-control bg-light" path="itm01IssCoNm" readonly="true" placeholder="기관팝업에서 선택"/>
                    </td>
